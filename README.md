...
skill treats them as a floor it will never trade away. If shipping safely depends on something
outside your ask, Claude stops and asks instead of deciding for you. The only thing it removes is
the stuff you never asked for.
